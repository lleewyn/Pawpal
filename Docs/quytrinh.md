...
Quy trình hoàn tất khi khách hàng nhấn nút "Xác nhận thay đổi", hệ thống hiển thị thông báo "Thay đổi lịch hẹn thành công" và thông tin được đồng bộ lên lịch vận hành của cửa hàng. Đồng thời, hệ thống gửi thông báo thay đổi lịch hẹn trực tiếp lên website (In-app notification).
Quy tắc nghiệp vụ 
...
Đối với tài khoản tạm, hệ thống yêu cầu khách hàng phải truy cập thông qua liên kết định danh trong SMS hoặc đã thiết lập mật khẩu trước đó mới có quyền thực hiện hủy lịch hẹn.
...
Sau khi hoàn tất toàn bộ quá trình chăm sóc, nhân viên cập nhật trạng thái "Hoàn tất chăm sóc". Tại thời điểm này, PawPal tự động tổng hợp các dịch vụ đã thực hiện và hiển thị hóa đơn dự kiến cho khách hàng trực tiếp trên website/Nhật ký chăm sóc của bé cưng. Hóa đơn bao gồm thông tin dịch vụ đã sử dụng, các khoản phát sinh (nếu có) và tổng chi phí cần thanh toán.
...
Khi lựa chọn một đơn hàng cụ thể, khách hàng được chuyển đến màn hình "Chi tiết đơn hàng". Tại đây, PawPal hiển thị đầy đủ các thông tin liên quan như danh sách sản phẩm đã mua, số lượng, đơn giá, tổng tiền thanh toán, địa chỉ giao hàng, phương thức thanh toán và lịch sử thay đổi trạng thái của đơn hàng. Đồng thời, khách hàng có thể theo dõi tiến trình xử lý thông qua các trạng thái như "Chờ xác nhận", "Đang chuẩn bị hàng", "Đang giao", "Đã giao hàng", "Hoàn thành", "Đã hủy" hoặc "Hoàn trả".
Khi đơn hàng được giao đến địa chỉ nhận hàng, PawPal cập nhật trạng thái đơn hàng sang "Đã giao hàng" và gửi thông báo đến khách hàng. Sau khi kiểm tra và nhận đủ sản phẩm, khách hàng có thể sử dụng chức năng "Xác nhận đã nhận hàng" trên màn hình chi tiết đơn hàng. Khi khách hàng xác nhận thành công, PawPal cập nhật trạng thái cuối cùng của đơn hàng thành "Hoàn thành" và lưu trữ đơn hàng trong khu vực "Lịch sử mua hàng". Trong trường hợp khách hàng không thực hiện xác nhận trong một khoảng thời gian quy định (ví dụ 3 ngày kể từ khi giao thành công), PawPal sẽ tự động chuyển đơn hàng sang trạng thái "Hoàn thành" nhằm kết thúc quy trình giao dịch.
...
FR2.4
Đăng nhập bằng SMS
Hệ thống phải hỗ trợ khách vãng lai đăng nhập nhanh thông qua mã OTP 6 số gửi qua SMS mà không cần nhập mật khẩu.
Rất cao
FR2.5
...
Hệ thống tự động gửi thông báo xác nhận hủy lịch trực tiếp trên website (In-app notification) cho khách hàng và gửi thông báo đẩy (push notification) lên màn hình Dashboard quản trị của Admin.
Cao
FR6.6
