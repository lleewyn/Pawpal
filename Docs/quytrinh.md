...
Đối với Khách hàng vãng lai, Pawpal cung cấp tính năng “Tra cứu dịch vụ” hiển thị công khai ngay trên Trang chủ. Khách hàng chỉ cần nhập số điện thoại và Pawpal sẽ hiển thị danh sách đơn hàng, lịch hẹn của họ ngay trên giao diện tra cứu. Khi khách hàng chọn một lịch hẹn có trạng thái "Đã xác nhận và nhấn nút "Thay đổi lịch". Ngay lập tức PawPal sẽ thông báo khách hàng đã có tài khoản tạm, khi thiết lập mật khẩu sẽ được hưởng trọn ưu đãi thành viên. Trên thông báo hiển thị kèm nút Thiết lập mật khẩu và nút Bỏ qua. Khi người dùng nhấn chọn nút Thiết lập mật khẩu, quy trình sẽ sẽ được tiếp tục với luồng Định danh lũy tiến. Khi hoàn tất, Pawpal tự động điều hướng về lại màn hình “Chọn lịch mới". Nếu khách hàng chọn bỏ qua, thì Pawpal sẽ yêu cầu xác thực OTP để có thể thực hiện việc thay đổi lịch hẹn.
...
Đối với khách hàng vãng lai, PawPal cung cấp tính năng “Tra cứu dịch vụ” hiển thị công khai trên Trang chủ. Khách hàng nhập số điện thoại đã sử dụng khi đặt lịch để tra cứu danh sách lịch hẹn tương ứng. Khi khách hàng lựa chọn một lịch hẹn có trạng thái “Đã xác nhận” và nhấn nút “Hủy lịch hẹn”, ngay lập tức PawPal sẽ thông báo khách hàng đã có tài khoản tạm, khi thiết lập mật khẩu sẽ được hưởng trọn ưu đãi thành viên. Trên thông báo hiển thị kèm nút Thiết lập mật khẩu và nút Bỏ qua. Khi người dùng nhấn chọn nút Thiết lập mật khẩu, quy trình sẽ sẽ được tiếp tục với luồng Định danh lũy tiến. Khi hoàn tất, Pawpal tự động điều hướng về lại màn hình “Chọn lịch mới". Nếu khách hàng chọn bỏ qua, thì Pawpal sẽ yêu cầu xác thực OTP để có thể thực hiện việc hủy lịch hẹn.
