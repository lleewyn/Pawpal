...
function initAuthForms() {
    ...
    if (triggerForgot && forgotSection) {
        ...
        forgotPasswordForm.addEventListener('submit', (e) => {
            ...
            showToast('success', 'Đã gửi link đặt lại mật khẩu thành công về số điện thoại của bạn, liên kết có hiệu lực trong 48h');
            
            // Simulate SMS link in console for testing
            console.log(`[SMS Simulation] Reset password link: ${window.location.origin}/pages/public/login.html?action=reset-password&token=${resetToken}`);
            
            // Reset form and go back
            forgotPasswordForm.reset();
            setTimeout(() => btnBackToLogin.click(), 2500);
        });
    }
