...
(function() {
    ...
    function updateHeaderAuth() {
        ...
        if (user && !user.is_temporary) {
            ...
            // Ẩn: Tra cứu, Đăng nhập, Đăng ký
            if (lookupBtn) lookupBtn.style.display = 'none';
            
            // Thay bằng: Avatar + Tên + Dropdown
            ...
            authActions.innerHTML = `
                <div class="user-menu-wrapper">
                    ...
                    <div class="user-dropdown" id="userDropdown">
                        ...
                        <a href="/pages/user/dashboard.html" class="dropdown-item">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        ...
                        <a href="/pages/user/pet-profile.html" class="dropdown-item">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        ...
                        <a href="/pages/user/orders.html" class="dropdown-item">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        ...
                        <a href="/pages/user/loyalty.html" class="dropdown-item">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            ...
            authActions.innerHTML = `
                ...
                <a href="/pages/public/login.html?action=setup-password" class="btn-signup">Kích hoạt tài khoản</a>
            `;
        } else {
            // Chưa đăng nhập: Giữ nguyên UI mặc định
            // (Header HTML đã có sẵn các nút Đăng nhập/Đăng ký)
        }
    }
