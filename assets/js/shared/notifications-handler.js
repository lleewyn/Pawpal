    ...
    const initialNotifications = [
        {
            ...
            read: false,
            link: '/pages/user/pet-diary/pet-diary.html'
        },
        {
            id: 'noti-2',
            type: 'order',
            ...
            read: false,
            link: '/pages/user/orders/orders.html'
        },
        {
            id: 'noti-3',
            type: 'promo',
            ...
            read: true,
            link: '/pages/user/loyalty/loyalty.html'
        },
        {
            id: 'noti-4',
            type: 'service',
            ...
            read: false,
            link: '/pages/services/booking/booking.html'
        },
        {
            id: 'noti-5',
            type: 'promo',
    ...
    function setupMockNotificationSimulator() {
        ...
        setTimeout(() => {
            ...
            addNotification(
                ...
                '/pages/user/pet-diary/pet-diary.html'
            );
        }, 15000);
    }
