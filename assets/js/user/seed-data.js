...
(function seedPawPalData() {
    ...
    const bookings = [
        ...
        /* ── Booking 9: Miu — Spa Mèo Cơ Bản — HOÀN THÀNH (45 ngày trước) ── */
        {
            ...
            selectedService: {
                id:       'SPA06',
                name:     'Tắm và Vệ Sinh Mèo Cơ Bản',
                category: 'Spa và Grooming',
                price:    '180.000đ',
            },
            petInfo: {
    ...
    trackerLogs['PP-100101'] = [
        {
            key: 'checkin', icon: '', label: 'Tiếp nhận và kiểm tra sức khỏe',
        ...
        {
            key: 'bath', icon: '', label: 'Tắm và vệ sinh',
        ...
        {
            key: 'dry', icon: '', label: 'Sấy khô và chải lông',
        ...
        {
            key: 'groom', icon: '️', label: 'Cắt tỉa và tạo kiểu',
        ...
        {
            key: 'finish', icon: '', label: 'Hoàn thiện và chụp ảnh kỷ niệm',
        ...
        {
            key: 'checkout', icon: '', label: 'Bàn giao và tổng kết',
    ...
    /* ── PP-100102: Bông — Tắm và Sấy Cơ Bản — HOÀN THÀNH ── */
    ...
    trackerLogs['PP-100103'] = [
        {
            key: 'checkin', icon: '', label: 'Check-in và kiểm tra sức khỏe',
        ...
        {
            key: 'settle', icon: '️', label: 'Ổn định phòng và làm quen',
        ...
        {
            key: 'meal', icon: '', label: 'Bữa ăn và uống nước',
        ...
        {
            key: 'play', icon: '', label: 'Vui chơi và vận động',
        ...
        {
            key: 'rest', icon: '', label: 'Nghỉ ngơi và ngủ trưa',
        ...
        {
            key: 'checkout', icon: '', label: 'Check-out và tổng kết',
    ...
    /* ── PP-100202: Miu — Tắm và Cắt Tỉa — ĐÃ ĐẶT (chưa bắt đầu) ── */
    trackerLogs['PP-100202'] = [
        { key: 'checkin',  icon: '', label: 'Tiếp nhận và kiểm tra sức khỏe', ...makeTime(daysFwd(3), 0),   isDone: false, isLive: false, isPending: true, staff: null, mood: null, note: null, image: null },
        { key: 'bath',     icon: '', label: 'Tắm và vệ sinh',                  ...makeTime(daysFwd(3), 40),  isDone: false, isLive: false, isPending: true, staff: null, mood: null, note: null, image: null },
        { key: 'dry',      icon: '', label: 'Sấy khô và chải lông',            ...makeTime(daysFwd(3), 80),  isDone: false, isLive: false, isPending: true, staff: null, mood: null, note: null, image: null },
        { key: 'groom',    icon: '️', label: 'Cắt tỉa và tạo kiểu',            ...makeTime(daysFwd(3), 115), isDone: false, isLive: false, isPending: true, staff: null, mood: null, note: null, image: null },
        { key: 'finish',   icon: '', label: 'Hoàn thiện và chụp ảnh kỷ niệm', ...makeTime(daysFwd(3), 150), isDone: false, isLive: false, isPending: true, staff: null, mood: null, note: null, image: null },
        { key: 'checkout', icon: '', label: 'Bàn giao và tổng kết',            ...makeTime(daysFwd(3), 175), isDone: false, isLive: false, isPending: true, staff: null, mood: null, note: null, image: null },
    ];
