            ...
            return `
                <div class="wishlist-card" data-product-id="${product.id}">
                    ...
                    <div class="wishlist-card-info">
                        ...
                        <a href="../shop/product-detail/product-detail.html?id=${product.id}" class="wishlist-card-name">${product.name}</a>
                        ...
                        <div class="wishlist-card-actions">
                            ...
                            <a href="../shop/product-detail/product-detail.html?id=${product.id}" class="wishlist-card-view-detail">
                                Chi tiết
                            </a>
                        </div>
                    </div>
